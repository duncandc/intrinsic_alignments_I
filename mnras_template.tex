...
\newcommand{\evectwo}[2]{\vec{e}_{\rm #1}^{\rm #2}}
\newcommand{\evechat}[1]{\hat{e}_{\rm #1}}
\newcommand{\evechattwo}[2]{\hat{e}_{\rm #1}^{\rm #2}}
...
%\begin{align}
%\begin{split}
%\mean{\vert\evec{i}\cdot\hat{r}\vert^{2}} &= 
%f_{\rm cen, 1}f_{\rm cen, 2}\mean{\vert\evechat{1}\cdot\hat{r}\vert^{2}} \\
%& + f_{\rm sat, 1}f_{\rm sat, 2}\mean{\vert\evec{sat, 1}\cdot\evec{sat, 2}\vert^{2}} \\
%\end{split}
%\end{align}
